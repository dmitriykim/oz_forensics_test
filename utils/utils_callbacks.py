...
class CallBackVerification(object):
    def __init__(self, frequent, rank, val_targets, rec_prefix, image_size=(32, 32)):
...
class CallBackModelCheckpoint(object):
    ...
    def __call__(self, global_step, backbone, partial_fc, epoch):
        if global_step > 100 and self.rank == 0:
            path_module = os.path.join(self.output, "ckpt_{}.pth".format(epoch))
